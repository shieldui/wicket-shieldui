...
public abstract class AbstractEventListenerBehavior extends AbstractDefaultAjaxBehavior
{
    ...
    protected ChartOptions.Event event;
    
    protected abstract void handleEvent(AjaxRequestTarget target, Object event);
    
    public AbstractEventListenerBehavior(ChartOptions.Event event)
    {
        super();
        this.event = event;
    }
    ...
    public void onConfigure(Component component)
    {
        ...
        ((Chart) component).getOptions().getEvents().put(event, new JsonFunction(callback));
    }
